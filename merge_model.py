...
parser.add_argument(
    "--base_model", type=str, default="nlpai-lab/kullm-polyglot-12.8b-v2"
)
parser.add_argument(
    "--lora_model_path",
    type=str,
    default="ckpt/polyglot-13b-kullm_v3-3e-5/sft_lora_model",
)
parser.add_argument(
    "--output_dir", type=str, default="ckpt/polyglot-13b-kullm_v3-3e-5"
)
...
print(
    "base_model vocab size:"
    f" {base_model.get_input_embeddings().weight.size(0)}"
)
...
lora_weight = lora_model.base_model.gpt_neox.layers[
    0
